# -*- coding: utf-8 -*-
"""
Created on Mon Sep  7 10:56:47 2020

@author: Dipak Kumar Mahato
"""
...
def create_app8_ui():
  main_layout = html.Div(style={'background-image':'url("/assets/img2.jpg")', 'padding':'25px'}, children=[
  html.H1('Terrorism Analysis with Insights', id='Main_title',style={'textAlign':'center', 'color':'orangered','background-color':'black','border-radius':'100px'}),
  html.Br(),html.Br(),
  
  dcc.Tabs(id="Tabs", value="Map",children=[
      dcc.Tab(label="Map tool" ,id="Map tool",value="Map",style={'backgroundColor':'black','color': 'white','border-radius':'100px'},selected_style={'backgroundColor':'black','color':'orangered','border-radius':'100px','borderColor':'red'}, children=[
          dcc.Tabs(id = "subtabs", value = "WorldMap",children = [
              dcc.Tab(label="World Map tool", id="World",style={'backgroundColor':'black','color': 'white','border-radius':'100px'},selected_style={'backgroundColor':'black','color':'orangered','border-radius':'100px','borderColor':'red'}, value="WorldMap"),
              dcc.Tab(label="India Map tool", id="India", style={'backgroundColor':'black','color': 'white','border-radius':'100px'},selected_style={'backgroundColor':'black','color':'orangered','border-radius':'100px','borderColor':'red'},value="IndiaMap")
              ]),
    html.Br(),
    html.Br(),
          dcc.Dropdown(
              id='month', 
                ...
                style={'width':'60%','margin-left':'20%','border-radius':'100px','background-color':'black','borderColor':'black'},
                multi = True
                  ),
    html.Br(),
          dcc.Dropdown(
                ...
                style={'width':'60%','margin-left':'20%','border-radius':'100px','background-color':'black','borderColor':'black','fontColor': 'red'},
                multi = True
                  ),
    ...
    html.Br(),
          ...
          html.H5('Select the Year', style={'textAlign':'center', 'color':'orangered','background-color':'black','border-radius':'100px'},id='year_title'),
          dcc.RangeSlider(
                    id='year-slider',
                    min=min(year_list),
                    max=max(year_list),
                    value=[min(year_list),max(year_list)],
                    marks={str(year):{'label':str(year),'style':{'color':'white'}} for year in year_list},
                    step=None
                      ),
          html.Br()
    ]),
      dcc.Tab(label = "Chart Tool", id="chart tool",style={'backgroundColor':'black','color': 'white','border-radius':'100px'},selected_style={'backgroundColor':'black','color':'orangered','border-radius':'100px','borderColor':'red'}, value="Chart", children=[
          dcc.Tabs(id = "subtabs2", value = "WorldChart",children = [
              dcc.Tab(label="World Chart tool", id="WorldC",style={'backgroundColor':'black','color': 'white','border-radius':'100px'},selected_style={'backgroundColor':'black','color':'orangered','border-radius':'100px','borderColor':'red'}, value="WorldChart"),          
            dcc.Tab(label="India Chart tool", id="IndiaC", style={'backgroundColor':'black','color': 'white','border-radius':'100px'},selected_style={'backgroundColor':'black','color':'orangered','border-radius':'100px','borderColor':'red'},value="IndiaChart")]),
    html.Br(),html.Br(),
            dcc.Dropdown(id="Chart_Dropdown",
                         options = chart_dropdown_values,
                         placeholder="Select option",
                         style={'width':'60%','margin-left':'20%','border-radius':'100px','background-color':'black','borderColor':'black','font-size':'20px'},
                         value = "region_txt"), 
            html.Br(),
            html.Br(),
            html.Hr(style={'background-color':'black','borderColor':'black'}),
            dcc.Input(id="search", placeholder="Search Filter",style={'backgroundColor':'black','border-radius':'100px','color':'white'}),
            html.Hr(style={'background-color':'black','borderColor':'black'}),
            html.Br(),
            dcc.RangeSlider(
                    id='cyear_slider',
  ...
  html.Div(id = "graph-object",style={'textAlign':'center', 'color':'orangered','background-color':'black','border-radius':'100px'}, children ="Graph will be shown here")
  ])
